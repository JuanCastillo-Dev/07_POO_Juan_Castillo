...
public class MainView extends BorderPane {
    ...
    // --- NUEVOS BOTONES AGREGADOS PARA EL RETO ---
    ...
    private void crearMenu(){
        ...
        // --- INICIALIZACIÓN DE LOS 3 NUEVOS BOTONES ---
        ...
        menu.getChildren().addAll(
                ...
                btnUsuarios,
                btnProductos,
                // --- AGREGAMOS LOS NUEVOS BOTONES AL CONTENEDOR VBOX ---
                btnReportes,
                btnConfiguracion,
                btnCitas
        );
    ...
    // =========================================================
    // --- NUEVO: PANTALLA DE REPORTES DE VENTAS ---
    // =========================================================
    public void mostrarReportes(){
        ...
        HBox tarjetas = new HBox(15);
        tarjetas.getChildren().addAll(
                crearTarjeta("Reporte Mensual", "Completado"),
                crearTarjeta("Productos Top", "5 Registrados"),
                crearTarjeta("Usuarios Activos", "12 En línea")
        );

        contenido.getChildren().addAll(titulo, tarjetas);
        setCenter(contenido); // Actualiza el área central dinámicamente
    }
    ...
    public void mostrarConfiguracion(){
        ...
        HBox tarjetas = new HBox(15);
        tarjetas.getChildren().addAll(
                crearTarjeta("Idioma Interfaz", "Español (PE)"),
                crearTarjeta("Modo Visual", "Tema Claro"),
                crearTarjeta("Seguridad", "Cifrado SSL")
        );
    ...
    // =========================================================
    // --- NUEVO: PANTALLA DE CITAS PROGRAMADAS ---
    // =========================================================
    public void mostrarCitas(){
        ...
        HBox tarjetas = new HBox(15);
        tarjetas.getChildren().addAll(
                crearTarjeta("Entrevista Trabajo", "Mañana 09:00 AM"),
                crearTarjeta("Reunión de Staff", "Viernes 04:00 PM"),
                crearTarjeta("Soporte Técnico", "Lunes 10:30 AM")
        );
